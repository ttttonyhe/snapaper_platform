...
function loobo_get_option_labels(){
	...
	$other_fields = array(
		...
		'title'=>'首页分类ID',	
	    'type'=>'text',	
		'description'=>'设置你想展示在首页的分类ID，用英文逗号隔开，不填则显示全部分类（tips:每个分类下至少要有三篇文章，否则样式会错位）'
		),
		'admin_date'	=> array(
		'title'=>'后台文章筛选',	
	    'type'=>'checkbox',	
	...
	$comment_fields = array(
		'ajax_comment_nav'	=> array(
		'title'=>'Ajax评论翻页',	
	    'type'=>'checkbox',	
		'description'=>'默认wordpress自导翻页功能，如需更好的用户体验，可以开启此功能（使用此功能需在讨论设置中设置分页显示评论，默认显示最后一页）'
		),
		'geetest_off'	=> array(
		'title'=>'关闭评论验证',	
	    'type'=>'checkbox',	
	...
	$sections = array( 
    	...
    	'comment'	=>array('title'=>'',	    'fields'=>$comment_fields,	'callback'=>'',	),
	);
