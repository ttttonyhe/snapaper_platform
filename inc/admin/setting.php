...
function display_loobo_menu() {
    ...
    add_menu_page('网站设置', '网站设置', 'administrator','barley', 'loobo_setting_page', $icon_url ,29);
    add_submenu_page('barley', '网站设置 &gt; 设置', '网站设置', 'administrator','barley', 'loobo_setting_page');
}
function loobo_setting_page(){
	...
	<div class="wrap">
		...
		<h2 class="nav-tab-wrapper">
			...
			<a class="nav-tab" href="javascript:;" id="tab-title-comment"><span class="m-r-10 dashicons dashicons-admin-comments"></span>评论设置</a> 
	    </h2>
