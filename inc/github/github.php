...
function wp_reposidget($atts) {
  ...
  $template = get_template_directory_uri() . "/inc/github/github.html";
  $pattern = '/{{([a-z_]+)}}/';
...
function wp_reposidget_editor_style() {
  wp_enqueue_style("reposidget_html", get_template_directory_uri() . "/inc/github/github-editor.css");
}

function wp_reposidget_editor() {
  if(wp_script_is("quicktags")) {
    $template = get_template_directory_uri() . "/inc/github/github-dialog.html";
    $pattern = '/{{([a-z_]+)}}/';
    $data = array(
...
?>
    <script type="text/javascript" src="<?php echo get_template_directory_uri() . "/inc/github/github-dialog.js"; ?>"></script>
...
function wp_reposidget_mce_plugin($plugin_array) {
  $plugin_array["reposidget_mce"] = get_template_directory_uri() . "/inc/github/github-mce.js";
  return $plugin_array;
}
...
add_filter('plugin_action_links_' . get_template_directory_uri() . "/inc/github/github.php", 'wp_reposidget_options_link');
